...
import com.module.network.tools.ping.PingNative.ping
...
object PingTools {
    ...
    private fun doJavaPing(ia: InetAddress?, pingOptions: PingOptions?): PingResult {
        ...
        try {
            ...
            val reached = ia.isReachable(null, pingOptions.getTimeToLive(), pingOptions.getTimeoutMillis())
            ...
            pingResult.isReachable = false
            pingResult.error = "NullPointerException: " + e.message
        }
        return pingResult
    }
}