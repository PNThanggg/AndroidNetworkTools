...
import com.module.network.tools.ping.PingOptions
import com.module.network.tools.ping.PingResult
import com.module.network.tools.ping.PingStats
import com.module.network.tools.ping.PingTools
...
class Ping private constructor() {
    ...
    private val pingOptions: PingOptions = PingOptions()
    ...
    fun doPing(pingListener: PingListener?): Ping {
        Thread(Runnable {
            ...
            while (noPings > 0 || times == 0) {
                val pingResult: PingResult = PingTools.doPing(address, pingOptions)
            ...
            pingListener?.onFinished(PingStats(address, pingsCompleted, noLostPackets, totalPingTime, minPingTime, maxPingTime))
        }).start()
        return this
    }
