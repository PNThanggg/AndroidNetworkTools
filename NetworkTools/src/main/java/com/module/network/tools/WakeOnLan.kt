...
private constructor() {
    ...
    companion object {
        const val DEFAULT_PORT: Int = 9
        const val DEFAULT_TIMEOUT_MILLIS: Int = 10000
        const val DEFAULT_NO_PACKETS: Int = 5
         ...
         */
        @Throws(IllegalArgumentException::class, IOException::class)
        fun sendWakeOnLan(address: InetAddress?, macStr: String?, port: Int, timeoutMillis: Int, packets: Int) {
            ...
            val macBytes = MACTools.getMacBytes(macStr)
